...
See [**TikTok Media Guidelines**](https://www.ayrshare.com/docs/media-guidelines/tiktok) and [**TikTok Authorization**](https://www.ayrshare.com/docs/dashboard/connect-social-accounts/tiktok) for more information.
