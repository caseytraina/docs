...
If you do not have any [Posting Personas](/essentials/personas) setup, you can do so here or in _Posting Personas_ on the left sidebar.
...
You can find these suggested posts in [`Social Calendar`](/essentials/social-calendar) on the left sidebar.
...
Open [`Social Calendar`](/essentials/social-calendar) from the left sidebar to view outgoing posts.
