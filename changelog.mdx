...
<Update label="April 12" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "Timeline and playback polish, reframe fixes, and media improvements" }}>
  ## Timeline and Playback

  - Improved playhead alignment and positioning in the studio timeline  
  - Smoothed clip scrolling and seek behavior, including fixes for clip-scroll playback and timeline syncing  
  - Tightened playback session handling and cleaned up stale playhead logging

  ## Reframe and Transitions

  - Limited transition options to video layers and refined the transitions panel behavior  
  - Reframe positions become fixed upon editing them 
  - Fixed aspect-ratio handling for full-length B-roll in the timeline

  ## Media and Performance

  - Fixed the media overlay slider behavior  
  - Added image optimization work to reduce rendering overhead  
  - Updated title overlay rich text layers and subtitle timing support
</Update>
